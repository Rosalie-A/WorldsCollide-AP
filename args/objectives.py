from worlds.ff6wc.WorldsCollide.constants.objectives import MAX_OBJECTIVES, MAX_CONDITIONS
...
def process(args):
    from worlds.ff6wc.WorldsCollide.constants.objectives.results import types as result_types
    from worlds.ff6wc.WorldsCollide.constants.objectives.results import id_type as result_id_type
