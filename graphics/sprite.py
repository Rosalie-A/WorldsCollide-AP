...
class Sprite:
    ...
    def write_ppm(self, output_file, pose):
        import worlds.ff6wc.WorldsCollide.graphics.poses as poses
        pose_values = self.tile_matrix(pose)
        ...
        from worlds.ff6wc.WorldsCollide.graphics.ppm import write_ppm6
    ...
    def get_ppm(self, pose):
        ...
        from worlds.ff6wc.WorldsCollide.graphics.ppm import get_ppm
